...
最近在跟一个前辈交流时，他说如果学到的知识不能够很清晰的表达出来，只能说对它还不够深入，这跟“搞技术，就该追本溯源”不谋而合。切入今天的主题是，Javascript作为一门弱类型语言，在使用数据类型时看似很简洁方便，但是也给跟我们带来许多迷惑。比如`13>3`和`"13">"3"`一样吗？`{}+1`会输出啥？本文是阅读《javscript权威指南》后记录的一章读书笔记，希望大家能从中收获一二，如有表述错误，欢迎指正。<!-- more -->
